...
Generates all pages with consistent layout, top navigation, and content-based naming
"""
...
SHARED_STYLES = '''
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-card .label { font-size: 0.75rem; color: #64748b; text-transform: uppercase; }
    .nav-card .title { font-weight: 600; color: #1e3a5f; }
    .resource-btn {
      display: inline-block;
      padding: 10px 20px;
      border-radius: 5px;
...
def generate_week_page(week, prev_week=None, next_week=None):
    """Generate a single week page with consistent layout"""
...
def generate_module_page(module):
    """Generate a module page with consistent layout"""
    ...
    <main class="main-content">
      ...
      <section class="resources">
        ...
        <div class="resource-buttons">
          <a href="https://github.com/Digital-AI-Finance/Natural-Language-Processing" class="resource-btn primary">GitHub Repo</a>
...
def main():
    ...
    print(f"  - {len(WEEKS)} topic pages")
    print(f"  - {len(MODULES)} module pages")
