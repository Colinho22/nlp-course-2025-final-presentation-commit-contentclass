...
\bottomnote{RAG: The most widely deployed technique for grounding LLMs in real-world facts.}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/29_rag_architecture}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/29_rag_architecture}{\includegraphics[width=0.55cm]{../FinalLecture/29_rag_architecture/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/29_rag_architecture}{\tiny\texttt{\textcolor{gray}{29\_rag\_architecture}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{HNSW and ANN algorithms make RAG practical at scale -- billions of vectors, millisecond latency.}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/02_hnsw_explanation}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/02_hnsw_explanation}{\includegraphics[width=0.55cm]{../FinalLecture/02_hnsw_explanation/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/02_hnsw_explanation}{\tiny\texttt{\textcolor{gray}{02\_hnsw\_explanation}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Agents extend LLMs from passive responders to active problem solvers.}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/10_agent_loop_equations}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/10_agent_loop_equations}{\includegraphics[width=0.55cm]{../FinalLecture/10_agent_loop_equations/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/10_agent_loop_equations}{\tiny\texttt{\textcolor{gray}{10\_agent\_loop\_equations}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Chain-of-Thought: A simple prompt change that dramatically improves reasoning.}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/27_intermediate_computation}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/27_intermediate_computation}{\includegraphics[width=0.55cm]{../FinalLecture/27_intermediate_computation/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/27_intermediate_computation}{\tiny\texttt{\textcolor{gray}{27\_intermediate\_computation}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Test-time compute: The new scaling law -- spending more compute at inference for harder problems.}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/35_test_time_scaling}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/35_test_time_scaling}{\includegraphics[width=0.55cm]{../FinalLecture/35_test_time_scaling/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/35_test_time_scaling}{\tiny\texttt{\textcolor{gray}{35\_test\_time\_scaling}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{RLHF/DPO: How ChatGPT and Claude learned to be helpful assistants, not just text predictors.}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/32_rlhf_vs_dpo}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/32_rlhf_vs_dpo}{\includegraphics[width=0.55cm]{../FinalLecture/32_rlhf_vs_dpo/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/32_rlhf_vs_dpo}{\tiny\texttt{\textcolor{gray}{32\_rlhf\_vs\_dpo}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Modern AI systems combine all these techniques -- retrieval, reasoning, and alignment working together.}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/19_convergence_diagram}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/19_convergence_diagram}{\includegraphics[width=0.55cm]{../FinalLecture/19_convergence_diagram/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/19_convergence_diagram}{\tiny\texttt{\textcolor{gray}{19\_convergence\_diagram}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{What changed? The architecture is largely the same transformer you learned in Week 5. So what's different?}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/11_ai_timeline}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/11_ai_timeline}{\includegraphics[width=0.55cm]{../FinalLecture/11_ai_timeline/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/11_ai_timeline}{\tiny\texttt{\textcolor{gray}{11\_ai\_timeline}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{You learned to predict words. Today: how to make those predictions USEFUL, SMART, and SAFE.}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/21_course_journey}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/21_course_journey}{\includegraphics[width=0.55cm]{../FinalLecture/21_course_journey/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/21_course_journey}{\tiny\texttt{\textcolor{gray}{21\_course\_journey}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Marginalization: Sum over all docs, each weighted by retrieval probability times generation probability}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/06_rag_conditional_probs}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/06_rag_conditional_probs}{\includegraphics[width=0.55cm]{../FinalLecture/06_rag_conditional_probs/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/06_rag_conditional_probs}{\tiny\texttt{\textcolor{gray}{06\_rag\_conditional\_probs}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Conditional probability: We restrict the sample space to the given event, then measure probability within it}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/07_rag_venn_diagrams}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/07_rag_venn_diagrams}{\includegraphics[width=0.55cm]{../FinalLecture/07_rag_venn_diagrams/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/07_rag_venn_diagrams}{\tiny\texttt{\textcolor{gray}{07\_rag\_venn\_diagrams}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Dense retrieval works by finding documents whose embeddings are closest to the query embedding}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/24_embedding_space_2d}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/24_embedding_space_2d}{\includegraphics[width=0.55cm]{../FinalLecture/24_embedding_space_2d/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/24_embedding_space_2d}{\tiny\texttt{\textcolor{gray}{24\_embedding\_space\_2d}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Rule of thumb: Start with 512 tokens, adjust based on your retrieval quality metrics}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/18_chunk_size_tradeoff}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/18_chunk_size_tradeoff}{\includegraphics[width=0.55cm]{../FinalLecture/18_chunk_size_tradeoff/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/18_chunk_size_tradeoff}{\tiny\texttt{\textcolor{gray}{18\_chunk\_size\_tradeoff}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Vector DBs enable fast retrieval: embed documents once, search in milliseconds at query time}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/08_vector_db_architecture}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/08_vector_db_architecture}{\includegraphics[width=0.55cm]{../FinalLecture/08_vector_db_architecture/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/08_vector_db_architecture}{\tiny\texttt{\textcolor{gray}{08\_vector\_db\_architecture}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{ANN is the key enabler for billion-scale vector search: trade small accuracy for massive speedup}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/01_ann_math_concept}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/01_ann_math_concept}{\includegraphics[width=0.55cm]{../FinalLecture/01_ann_math_concept/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/01_ann_math_concept}{\tiny\texttt{\textcolor{gray}{01\_ann\_math\_concept}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Each layer narrows the search: start broad at the top, refine at the bottom}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/03_hnsw_cities_example}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/03_hnsw_cities_example}{\includegraphics[width=0.55cm]{../FinalLecture/03_hnsw_cities_example/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/03_hnsw_cities_example}{\tiny\texttt{\textcolor{gray}{03\_hnsw\_cities\_example}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Chunking is often the difference between RAG that works and RAG that fails -- start with 512 tokens, 10\% overlap}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/17_chunking_strategies_visual}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/17_chunking_strategies_visual}{\includegraphics[width=0.55cm]{../FinalLecture/17_chunking_strategies_visual/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/17_chunking_strategies_visual}{\tiny\texttt{\textcolor{gray}{17\_chunking\_strategies\_visual}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{RAG requires careful engineering at every pipeline stage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/05_rag_failures}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/05_rag_failures}{\includegraphics[width=0.55cm]{../FinalLecture/05_rag_failures/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/05_rag_failures}{\tiny\texttt{\textcolor{gray}{05\_rag\_failures}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Agents are LLMs in a loop -- the magic is in the orchestration, not a new architecture}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/09_agent_loop}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/09_agent_loop}{\includegraphics[width=0.55cm]{../FinalLecture/09_agent_loop/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/09_agent_loop}{\tiny\texttt{\textcolor{gray}{09\_agent\_loop}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Self-consistency adds 5-10\% accuracy on top of CoT by marginalizing over reasoning paths}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/33_self_consistency_voting}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/33_self_consistency_voting}{\includegraphics[width=0.55cm]{../FinalLecture/33_self_consistency_voting/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/33_self_consistency_voting}{\tiny\texttt{\textcolor{gray}{33\_self\_consistency\_voting}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Key insight: Reasoning models show log-linear improvement with inference tokens; standard models plateau}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/26_inference_scaling_curve}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/26_inference_scaling_curve}{\includegraphics[width=0.55cm]{../FinalLecture/26_inference_scaling_curve/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/26_inference_scaling_curve}{\tiny\texttt{\textcolor{gray}{26\_inference\_scaling\_curve}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{DeepSeek-R1 shows that open-source reasoning can match proprietary models with clever training}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/22_deepseek_r1_pipeline}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/22_deepseek_r1_pipeline}{\includegraphics[width=0.55cm]{../FinalLecture/22_deepseek_r1_pipeline/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/22_deepseek_r1_pipeline}{\tiny\texttt{\textcolor{gray}{22\_deepseek\_r1\_pipeline}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{RLHF requires orchestrating 3 models: policy, reference, and reward model in an iterative loop}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/31_rlhf_detailed_pipeline}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/31_rlhf_detailed_pipeline}{\includegraphics[width=0.55cm]{../FinalLecture/31_rlhf_detailed_pipeline/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/31_rlhf_detailed_pipeline}{\tiny\texttt{\textcolor{gray}{31\_rlhf\_detailed\_pipeline}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Reward hacking is why RLHF uses KL penalty: prevent policy from drifting too far from reference}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/30_reward_hacking_examples}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/30_reward_hacking_examples}{\includegraphics[width=0.55cm]{../FinalLecture/30_reward_hacking_examples/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/30_reward_hacking_examples}{\tiny\texttt{\textcolor{gray}{30\_reward\_hacking\_examples}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{DPO achieves comparable results to RLHF with dramatically simpler training infrastructure}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/23_dpo_vs_rlhf_comparison}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/23_dpo_vs_rlhf_comparison}{\includegraphics[width=0.55cm]{../FinalLecture/23_dpo_vs_rlhf_comparison/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/23_dpo_vs_rlhf_comparison}{\tiny\texttt{\textcolor{gray}{23\_dpo\_vs\_rlhf\_comparison}}}
    };
  \end{tikzpicture}
\end{frame}
...
\bottomnote{Clear trend: From complex RL pipelines toward simpler, more direct preference optimization}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % Logo (clickable)
    \node[anchor=south east,xshift=-0.3cm,yshift=0.5cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/12_alignment_timeline}{\includegraphics[width=0.7cm]{../logo/quantlet.png}}
    };
    % QR Code (clickable)
    \node[anchor=south east,xshift=-1.2cm,yshift=0.5cm,opacity=0.85] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/12_alignment_timeline}{\includegraphics[width=0.55cm]{../FinalLecture/12_alignment_timeline/qr_code.png}}
    };
    % URL text
    \node[anchor=south east,xshift=-0.3cm,yshift=0.15cm] at (current page.south east) {
      \href{https://github.com/Digital-AI-Finance/Natural-Language-Processing/tree/main/FinalLecture/12_alignment_timeline}{\tiny\texttt{\textcolor{gray}{12\_alignment\_timeline}}}
    };
  \end{tikzpicture}
\end{frame}
