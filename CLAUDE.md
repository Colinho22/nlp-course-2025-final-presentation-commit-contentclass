...
**Last Major Update**: 2025-11-20 (Week 9 Decoding: Learning Goals, simplified notebook, all fixes complete)
...
9. **Decoding**: `20251120_1330_week09_temp_fixed.pdf` (67 slides, Learning Goals + all chart improvements)
...
### Week 9 Final Updates (Nov 20, 2025)
**CANONICAL VERSION**: `20251120_1330_week09_temp_fixed.pdf` (67 slides)
...
2. **Learning Goals & Plan Slide ADDED** (Slide 2):
   - Problem-driven goals: Discover why one-word-at-a-time creates problems
   - Flow-based plan: Challenge → Toolbox → Hands-on
   - References Jupyter notebook for practical work

3. **Greedy's Fatal Flaw Chart SIMPLIFIED** (18×10 size):
   - Removed KEY INSIGHT box, VS arrow, probability explanations
   - Streamlined to: Two paths + probabilities + one simple takeaway
   - 24pt/18pt font hierarchy for maximum readability
   - Figure size increased to 18×10 inches
   - ~40% content reduction for clarity

4. **Temperature Notation FIXED**:
   - Changed `T < 1` and `T > 1` to proper math mode: `$T < 1$` and `$T > 1$`
   - Fixed Unicode ≠ to `$\neq$`

5. **Lab Notebook REORGANIZED**:
   - Simplified notebook renamed to main: `week09_decoding_lab.ipynb`
   - Original comprehensive moved to `lab/archive/`
   - Fixed all tensor indexing errors (1D vs 2D)
   - Correct cell ordering (functions defined before use)

**Files**:
- `20251120_1330_week09_temp_fixed.pdf` - Final 67-slide presentation
- `week09_decoding_lab.ipynb` - Simplified lab notebook (main)
- `week09_decoding_lab.html` - HTML with outputs (724 KB)
- `archive/` - Original comprehensive notebook (13 sections)
