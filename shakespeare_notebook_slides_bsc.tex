...
\begin{itemize}
    ...
    \item Creates somewhat readable lines
    \item Allows theme selection
    \item Produces unique lines each time
\end{itemize}

\column{0.48\textwidth}
\textbf{What It DOESN'T:}
\begin{itemize}
    \item No rhyme scheme (ABAB CDCD...)
    \item No iambic pentameter
    \item No semantic coherence across lines
    \item No deep understanding of meaning
    \item No emotional progression
    \item No metaphor development
\end{itemize}
\end{columns}
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black]
\centering
\textbf{Key Insight:} N-gram models capture local patterns but miss global structure and meaning!
\end{tcolorbox}
\end{frame}
...
\begin{columns}[T]
\column{0.5\textwidth}
\textbf{What Students Learn:}
\begin{itemize}
    \item Building language models from scratch
    \item Statistical text generation
    \item Limitations of simple models
    \item Importance of evaluation metrics
    \item Hands-on Python implementation
\end{itemize}
...
\begin{itemize}
    \item Modify n-gram order
    \item Change themes
    \item Adjust generation parameters
    \item Create custom sonnets
    \item Compare with real Shakespeare
\end{itemize}
...
% Next Steps
\begin{frame}{Extensions and Next Steps}
\begin{columns}[T]
\column{0.5\textwidth}
\textbf{Immediate Extensions:}
\begin{itemize}
    \item Try different n values (3, 4, 5)
    \item Mix multiple text sources
    \item Add rhyme detection
    \item Implement syllable constraints
    \item Create other poetry forms
\end{itemize}

\vspace{0.5em}
\textbf{Advanced Topics (Future):}
\begin{itemize}
    \item Neural language models
    \item Word embeddings
    \item RNNs and LSTMs
    \item Transformer models
    \item Fine-tuning GPT
\end{itemize}
...
% Summary
\begin{frame}{Summary: From Notebooks to Understanding}
\begin{center}
\textbf{What Makes This Notebook Effective for Learning}
\end{center}
...
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Immediate Feedback]
\small
\begin{itemize}
    \item See results instantly
    \item Visualize patterns
    \item Generate real text
    \item Compare outputs
\end{itemize}
\end{tcolorbox}

\column{0.33\textwidth}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Hands-On Code]
\small
\begin{itemize}
...
\column{0.33\textwidth}
\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=Clear Limitations]
\small
\begin{itemize}
    \item No magic/hype
    \item Honest results
    \item Visible failures
    \item Room to improve
\end{itemize}
\end{tcolorbox}
\end{columns}
...
\begin{center}
\large
\textbf{Students build intuition through experimentation, not just theory!}
\end{center}
\end{frame}
