...
% Slide 2: NEWEST - What This Is About (Predicting Next Word)
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{tikzpicture}[scale=0.85]
                ...
                \node[above, blue] at (5.75,0.8) {\scriptsize water};
            \end{tikzpicture}
            ...
            \textbf{Remember:}
            \begin{itemize}\setlength\itemsep{0.2em}
                \item Tank holds memory (water)
                \item OUTPUT tap controls flow
                \item 0.9 = 90\% flows out
                \item 0.3 = 30\% flows out
            \end{itemize}

            \vspace{0.3em}
            \textbf{Question:} What happens to that water?
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{tikzpicture}[scale=0.85]
                ...
                \node[above, blue] at (0.75,2) {\scriptsize from tap};

                % Prediction Machine Box
                \draw[thick, fill=orange!10] (1.5,0.5) rectangle (5.5,3.5);
                \node at (3.5,3) {\textbf{Prediction Machine}};
                \node at (3.5,2.5) {\scriptsize Uses water to predict};
            ...
            \centering
            \textbf{Tank} → OUTPUT tap (0.9) → 90\% of water
            ...
            \textbf{Next word predictions!}
            }}

            \vspace{0.5em}
            \begin{checkpoint}[Aha Moment!]
            \tiny
            The tap water IS the hidden state $h_t$!

            It flows to the prediction layer.

            That's why OUTPUT gate matters - it controls what information reaches the predictions!
            \end{checkpoint}
        \end{column}
    \end{columns}
...
% Slide 8: Why Three Separate Gates? (Scenarios)
