...
\begin{frame}[t]{State of the Art: Embedding APIs (2024)}
    \textbf{Commercial Embedding Services:}
    
    \vspace{0.5em}
    \begin{center}
    \begin{tabular}{|l|c|c|c|}
        \hline
        \textbf{Provider} & \textbf{Model} & \textbf{Dimensions} & \textbf{Price/1M tokens} \\
        \hline
        OpenAI & text-embedding-3-large & 3,072 & \$0.13 \\
        OpenAI & ada-002 & 1,536 & \$0.10 \\
        Cohere & embed-v3 & 1,024 & \$0.10 \\
        Google & gecko-003 & 768 & \$0.05 \\
        Anthropic & voyage-2 & 1,024 & \$0.12 \\
        \hline
    \end{tabular}
    \end{center}
    
    \vspace{0.5em}
    \textbf{Vector Databases (Store and Search Embeddings):}
    \begin{itemize}
        \item Pinecone: \$70M funding, billions of vectors
        \item Weaviate: Open source, 300M+ downloads
        \item Chroma: Local-first, developer friendly
        \item Qdrant: High performance, Rust-based
    \end{itemize}
    
    \vspace{0.5em}
    \highlight{Market Size: \$4.3B by 2028, 35\% CAGR}
\end{frame}
...
%============================================================================
\section{Appendix B: Practical Notebook}
%============================================================================

\begin{frame}[t]{Appendix B: Hands-On Notebook Exercises}
    \textbf{Available in: week02\_word2vec\_notebook.ipynb}
    
    \vspace{0.5em}
    \textbf{Exercise 1: Train Word2Vec from Scratch}
    \begin{itemize}
        \item Load text corpus (Wikipedia sample)
        \item Implement skip-gram with negative sampling
        \item Visualize training progress
        \item Save trained embeddings
    \end{itemize}
    
    \textbf{Exercise 2: Word Arithmetic Playground}
    \begin{itemize}
        \item Load pre-trained embeddings
        \item Implement analogy solver
        \item Test on Google analogy dataset
        \item Create your own analogies
    \end{itemize}
    
    \textbf{Exercise 3: Bias Detection}
    \begin{itemize}
        \item Measure gender bias in embeddings
        \item Visualize bias directions
        \item Implement simple debiasing
        \item Compare before/after
    \end{itemize}
    
    \textbf{Exercise 4: Build Applications}
    \begin{itemize}
        \item Semantic search engine
        \item Document clustering
        \item Simple chatbot with semantic understanding
    \end{itemize}
\end{frame}
