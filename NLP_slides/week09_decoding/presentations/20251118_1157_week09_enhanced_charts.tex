% Week 9: Decoding Strategies - Reorganized with Enhanced Charts
% ~66 main slides + 25 appendix slides
% Enhanced: November 18, 2025 | Reordered charts + Full exploration tree + Split coverage
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.95\textwidth]{figures/extreme_full_beam_explosion_bsc.pdf}
\end{center}

\bottomnote{Extreme 2: Too broad - exponential explosion makes this impossible}
\end{frame}

% === NEW SLIDE 7: FULL EXPLORATION - ALL CHARTS ===
\begin{frame}[t]{Full Exploration: Exponential Explosion - Complete View}
\vspace{-0.5cm}
\begin{columns}[T]
\column{0.33\textwidth}
\textbf{Tree Structure}:
\vspace{2mm}
\includegraphics[width=\textwidth]{figures/full_exploration_tree_graphviz.pdf}
\vspace{2mm}
\footnotesize 100 → 10K → 1M → 10B paths

\column{0.33\textwidth}
\textbf{Mathematical Growth}:
\vspace{2mm}
\includegraphics[width=\textwidth]{figures/extreme_full_beam_explosion_bsc.pdf}
\vspace{2mm}
\footnotesize $V^T$ = $100^5$ paths

\column{0.33\textwidth}
\textbf{Time Cost}:
\vspace{2mm}
\includegraphics[width=\textwidth]{figures/extreme_computational_cost_bsc.pdf}
\vspace{2mm}
\footnotesize 36+ hours for full search
\end{columns}

\bottomnote{Three perspectives on why exhaustive search is impossible: structure, math, time}
\end{frame}

% === SLIDE 8: THE EXTREMES - ALL COVERAGE CHARTS ===
\begin{frame}[t]{The Extremes: Coverage Comparison - All Methods}
\vspace{-0.5cm}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{The Extremes}:
\includegraphics[width=\textwidth]{figures/extreme_coverage_comparison_bsc.pdf}
\vspace{2mm}
\footnotesize Greedy: 0.01\% | Full: 100\%

\column{0.48\textwidth}
\textbf{Old 4-Panel View} (for reference):
\includegraphics[width=\textwidth]{figures/extreme_search_space_coverage_bsc.pdf}
\vspace{2mm}
\footnotesize Shows all methods at once
\end{columns}
\vspace{3mm}
\textbf{Key Insight}: Neither extreme is practical - we need balanced approaches

\bottomnote{Coverage visualization: from single path to complete exploration}
\end{frame}

% === SLIDE 10: PRACTICAL SOLUTIONS (NEW - SPLIT 2 of 2) ===
\begin{frame}[t]{Practical Solutions: Finding the Sweet Spot}
\vspace{-0.5cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{figures/practical_methods_coverage_bsc.pdf}
\end{center}
\vspace{1mm}
\textbf{Key Insight}: Good methods explore 1-5\% of space strategically

\textbf{Next}: Meet the 6 methods in our decoding toolbox

\bottomnote{Beam Search, Top-k, and Nucleus balance coverage with computation}
\end{frame}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{figures/beam_search_tree_graphviz.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{figures/contrastive_vs_nucleus_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{figures/quality_diversity_scatter_bsc.pdf}
\end{center}
\vspace{3mm}
