...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.80\textwidth]{../python/charts_individual/vocabulary_probability_bsc/vocabulary_probability_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/prediction_to_text_pipeline_bsc/prediction_to_text_pipeline_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.90\textwidth]{../python/charts_individual/extreme_greedy_single_path_bsc/extreme_greedy_single_path_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/greedy_suboptimal_comparison_bsc/greedy_suboptimal_comparison_bsc.pdf}
\end{center}
\vspace{2mm}
\textbf{The Problem}: High first-step probability $\neq$ Best complete sentence
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{../python/charts_individual/extreme_full_beam_explosion_bsc/extreme_full_beam_explosion_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.65\textwidth]{../python/charts_individual/full_exploration_tree_graphviz/full_exploration_tree_graphviz.pdf}
\end{center}
\vspace{1mm}
\textbf{The Problem}: How do we explore more than 1 but less than 10 billion paths?
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.65\textwidth]{../python/charts_individual/extreme_coverage_comparison_bsc/extreme_coverage_comparison_bsc.pdf}
\end{center}
...
\vspace{5mm}
\textbf{Key Insight}: We need methods that explore 1-5\% of space intelligently
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/practical_methods_coverage_bsc/practical_methods_coverage_bsc.pdf}
\end{center}
\vspace{3mm}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.65\textwidth]{../python/charts_individual/beam_search_tree_graphviz/beam_search_tree_graphviz.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.65\textwidth]{../python/charts_individual/temperature_effects_bsc/temperature_effects_bsc.pdf}
\end{center}
\begin{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{../python/charts_individual/temperature_calculation_bsc/temperature_calculation_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{../python/charts_individual/topk_filtering_bsc/topk_filtering_bsc.pdf}
\end{center}
\begin{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{../python/charts_individual/topk_example_bsc/topk_example_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{../python/charts_individual/nucleus_process_bsc/nucleus_process_bsc.pdf}
\end{center}
\begin{center}
...
% === NUCLEUS EXAMPLE 2 (MOVED FROM SLIDE 38) ===
\begin{frame}[t]{Nucleus: How Distribution Shape Matters}
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{../python/charts_individual/nucleus_cumulative_bsc/nucleus_cumulative_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{../python/charts_individual/degeneration_problem_bsc/degeneration_problem_bsc.pdf}
\end{center}
\begin{center}
...
\begin{center}
\vspace{-3mm}
\includegraphics[width=0.60\textwidth]{../python/charts_individual/contrastive_mechanism_bsc/contrastive_mechanism_bsc.pdf}
\end{center}
\begin{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.62\textwidth]{../python/charts_individual/contrastive_vs_nucleus_bsc/contrastive_vs_nucleus_bsc.pdf}
\end{center}
...
\vspace{-0.5cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/problem1_repetition_output_bsc/problem1_repetition_output_bsc.pdf}
\end{center}
\vspace{2mm}
\textbf{Greedy's Problem}: Trapped in loops, can't escape

\textbf{Why Beam Helps}: Explores k=3-5 paths, avoids greedy trap
...
\vspace{-0.5cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/problem2_diversity_output_bsc/problem2_diversity_output_bsc.pdf}
\end{center}
\vspace{2mm}
\textbf{Greedy \& Beam's Problem}: Same input → same output always

\textbf{Why Temperature Helps}: Sampling introduces randomness, enables creativity
...
\vspace{-0.5cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/problem3_balance_output_bsc/problem3_balance_output_bsc.pdf}
\end{center}
\vspace{2mm}
\textbf{Temperature's Problem}: Pure sampling includes low-quality words

\textbf{Why Top-k Helps}: Filter to k=50 best words, then sample
...
\column{0.48\textwidth}
\vspace{-0.3cm}
\includegraphics[width=\textwidth]{../python/charts_individual/problem4_search_tree_pruning_bsc/problem4_search_tree_pruning_bsc.pdf}

\vspace{2mm}
\includegraphics[width=\textwidth]{../python/charts_individual/problem4_path_comparison_bsc/problem4_path_comparison_bsc.pdf}

\column{0.48\textwidth}
\vspace{-0.3cm}
\includegraphics[width=\textwidth]{../python/charts_individual/problem4_probability_evolution_bsc/problem4_probability_evolution_bsc.pdf}

\vspace{2mm}
\includegraphics[width=\textwidth]{../python/charts_individual/problem4_recovery_problem_bsc/problem4_recovery_problem_bsc.pdf}
\end{columns}
...
\vspace{-0.5cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/problem5_distribution_output_bsc/problem5_distribution_output_bsc.pdf}
\end{center}
\vspace{2mm}
\textbf{Top-k's Problem}: Fixed k doesn't adapt to distribution shape

\textbf{Why Nucleus Helps}: Adaptive cutoff at p=0.9 probability mass
...
\vspace{-0.5cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/problem6_speed_output_bsc/problem6_speed_output_bsc.pdf}
\end{center}
\vspace{2mm}
\textbf{All Methods' Problem}: Can still produce generic, repetitive text

\textbf{Why Contrastive Helps}: Explicitly penalizes similarity to previous tokens
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.63\textwidth]{../python/charts_individual/quality_diversity_scatter_bsc/quality_diversity_scatter_bsc.pdf}
\end{center}
\vspace{1mm}
\textbf{Key Insight}: We saw problems and their solutions. Each method balances quality vs diversity.
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.63\textwidth]{../python/charts_individual/quality_diversity_pareto_bsc/quality_diversity_pareto_bsc.pdf}
\end{center}
\begin{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{../python/charts_individual/task_method_decision_tree_bsc/task_method_decision_tree_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/task_recommendations_table_bsc/task_recommendations_table_bsc.pdf}
\end{center}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../python/charts_individual/production_settings_bsc/production_settings_bsc.pdf}
\end{center}
