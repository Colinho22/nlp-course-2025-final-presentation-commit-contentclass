% Week 9: Decoding Strategies - Complete with All Charts
% 65 main slides + 25 appendix slides
% Enhanced: November 18, 2025 | All charts combined on key slides for complete view
...
% === SLIDE 7: FULL EXPLORATION - CONTRAST VIEW ===
...
\textbf{Greedy: 1 Path}
\vspace{2mm}
\includegraphics[width=\textwidth]{figures/extreme_greedy_single_path_bsc.pdf}
\vspace{2mm}
\small Single deterministic path

\column{0.33\textwidth}
\textbf{Full: Tree Explosion}
\vspace{2mm}
\includegraphics[width=\textwidth]{figures/full_exploration_tree_graphviz.pdf}
\vspace{2mm}
\small 10 billion paths
...
\vspace{2mm}
\small Microseconds → Days
\end{columns}
\vspace{2mm}
\textbf{The Problem}: How do we explore more than 1 but less than 10 billion paths?

\bottomnote{Contrasting the extremes: deterministic single path vs exponential explosion}
\end{frame}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.75\textwidth]{figures/extreme_coverage_comparison_bsc.pdf}
\end{center}
