% Week 9: Decoding Strategies - Enhanced with Extreme Cases & Redesigned Charts
% 41 main slides + 25 appendix slides = 66 total
% NEW: 4 extreme case slides before problems + 4 graphviz charts for Problem 4
% Enhanced: November 16, 2025 | Template: template_beamer_final.tex
...
% === SLIDE 8: SEARCH SPACE COVERAGE ===
\begin{frame}[t]{Finding the Sweet Spot}
\vspace{-0.5cm}
\begin{center}
\includegraphics[width=0.70\textwidth]{figures/extreme_search_space_coverage_bsc.pdf}
\end{center}
\vspace{1mm}
...
\bottomnote{Coverage heat maps show how different methods explore the search space}
\end{frame}

% ============================================
% THE TOOLBOX: 6 Methods Introduction (Slides 9-14)
% ============================================
...
% ============================================
% THE 6 PROBLEMS (Now Slides 16-21)
% ============================================
...
% === NEW POSITION: QUALITY-DIVERSITY TRADEOFF (AFTER PROBLEMS) ===
...
\end{center}
\vspace{3mm}
\textbf{Key Insight}: We just saw the extremes. Now we need methods to find the sweet spot.
...
4. Nucleus (p=0.9, T=0.7) \quad 5. Greedy (T=0) \quad 6. Contrastive ($lpha$=0.6)
}}
\end{center}
