...
% Slide 3: The Six Problems (Progressive Reveal)
\begin{frame}{Six Real Problems from Real Models}
    \begin{center}
    {\large\bfseries What's Wrong with Each Output?}
    \end{center}
    ...
    \pause
    \textbf{1.} \texttt{``The cat sat on the cat sat on the cat...''}

    \vspace{0.2em}

    \pause
    \textbf{2.} Ask 100 times: \texttt{``The weather is \_\_''}\\
    \hspace{1em}Always get: \texttt{``nice''}

    \vspace{0.2em}

    \pause
    \textbf{3.} \texttt{``The weather is xylophone dancing''}

    \vspace{0.2em}

    \pause
    \textbf{4.} \texttt{``Paris is capital of France and zlorfnik''}

    \vspace{0.2em}

    \pause
    \textbf{5.} Set k=40. Peaked: top word P=0.9, rest junk. Flat: 100 words at P=0.01, but only see 40.

    \vspace{0.2em}

    \pause
    \textbf{6.} Poetry vs factual QA vs code:\\
    \hspace{1em}One strategy for all?
    ...
    {\small\color{gray}(needs path exploration)}

    \vspace{0.2em}

    \pause
    No diversity, always picks max\\
    {\small\color{gray}(needs randomness)}

    \vspace{0.2em}

    \pause
    Too random, nonsensical\\
    {\small\color{gray}(needs controlled randomness)}

    \vspace{0.2em}

    \pause
    Picks very rare words (P=0.00001)\\
    {\small\color{gray}(needs vocabulary limit)}

    \vspace{0.2em}

    \pause
    Fixed vocab size doesn't adapt\\
    {\small\color{gray}(needs dynamic cutoff)}

    \vspace{0.2em}

    \pause
    Different tasks need different approaches\\
    {\small\color{gray}(needs task-specific strategy)}
    \end{columns}
    ...
    \pause
    \begin{center}
    {\footnotesize\color{gray}Next slide: The solutions to each problem!}
    \end{center}
\end{frame}

% Slide 4: The Six Solutions (Progressive Reveal)
\begin{frame}{The Six Solutions}
    \begin{center}
    {\large\bfseries Each Problem Has Its Decoding Strategy}
    \end{center}
    ...
    \pause
    \textbf{1.} Repetition loops

    \vspace{0.3em}

    \pause
    \textbf{2.} No diversity (always max)

    \vspace{0.3em}

    \pause
    \textbf{3.} Too random/nonsensical

    \vspace{0.3em}

    \pause
    \textbf{4.} Very rare words

    \vspace{0.3em}

    \pause
    \textbf{5.} Fixed vocab size

    \vspace{0.3em}

    \pause
    \textbf{6.} Different task types
    ...
    \pause
    \textbf{Beam Search}\\
    {\small\color{gray}Explore multiple paths simultaneously}

    \vspace{0.3em}

    \pause
    \textbf{Sampling}\\
    {\small\color{gray}Add randomness to selection}

    \vspace{0.3em}

    \pause
    \textbf{Temperature}\\
    {\small\color{gray}Control the randomness level}

    \vspace{0.3em}

    \pause
    \textbf{Top-k Sampling}\\
    {\small\color{gray}Limit to top-k most likely words}

    \vspace{0.3em}

    \pause
    \textbf{Top-p (Nucleus)}\\
    {\small\color{gray}Adaptive vocabulary based on cumulative probability}

    \vspace{0.3em}

    \pause
    \textbf{Task-Specific Strategy}\\
    {\small\color{gray}Match decoding method to task requirements}
    \end{columns}
    ...
    \pause
    \begin{center}
    {\footnotesize\color{gray}Today we'll learn each of these strategies in detail!}
    \end{center}
\end{frame}

% Slide 5: Six Problems to Solve (with Examples)
\begin{frame}{Six Problems We Need to Solve Today}
    ...
    \begin{tcolorbox}[colback=red!10, colframe=red!50, title=\textbf{Problem 1: Repetition Loop}]
    \small
    \texttt{``The cat sat on the cat sat on the cat...''}\\
    Model gets stuck repeating!

    \vspace{0.1em}
    \textcolor{blue}{\textbf{→ Beam Search}}
    \end{tcolorbox}

    \vspace{0.25em}

    \begin{tcolorbox}[colback=orange!10, colframe=orange!50, title=\textbf{Problem 2: Always Boring}]
    \small
    Ask 100 times: \texttt{``The weather is \_\_''}\\
    Always: \texttt{``nice''} (never ``gorgeous'')

    \vspace{0.1em}
    \textcolor{blue}{\textbf{→ Sampling}}
    \end{tcolorbox}

    \vspace{0.25em}

    \begin{tcolorbox}[colback=yellow!10, colframe=yellow!50, title=\textbf{Problem 3: Random Nonsense}]
    \small
    \texttt{``The weather is xylophone dancing''}\\
    Too creative = gibberish!

    \vspace{0.1em}
    \textcolor{blue}{\textbf{→ Temperature}}
    \end{tcolorbox}

    \column{0.48\textwidth}

    \begin{tcolorbox}[colback=green!10, colframe=green!50, title=\textbf{Problem 4: Weird Words}]
    \small
    \texttt{``Paris is the capital of France and zlorfnik''}\\
    Picks ultra-rare words (P=0.00001)

    \vspace{0.1em}
    \textcolor{blue}{\textbf{→ Top-k}}
    \end{tcolorbox}

    \vspace{0.25em}

    \begin{tcolorbox}[colback=cyan!10, colframe=cyan!50, title=\textbf{Problem 5: Fixed Vocabulary}]
    \small
    Peaked dist: top-40 = overkill\\
    Flat dist: top-40 = too few

    \vspace{0.1em}
    \textcolor{blue}{\textbf{→ Top-p (Nucleus)}}
    \end{tcolorbox}

    \vspace{0.25em}

    \begin{tcolorbox}[colback=purple!10, colframe=purple!50, title=\textbf{Problem 6: Which Method?}]
    \small
    Creative writing? Factual QA?\\
    Code generation? Different needs!

    \vspace{0.1em}
    \textcolor{blue}{\textbf{→ Task Guide}}
    \end{tcolorbox}
    \end{columns}
    ...
    \begin{center}
    {\footnotesize\color{gray}Today we solve all 6 problems with concrete examples!}
    \end{center}
\end{frame}

% Slide 6: What We Learned So Far - Part 1
\begin{frame}{What We've Learned So Far}
    \begin{center}
    \includegraphics[width=0.95\textwidth,height=0.85\textheight,keepaspectratio]{../figures/weeks_pipeline_graphviz.pdf}
    \end{center}
\end{frame}

% Slide 7: What We Learned So Far - Part 2
\begin{frame}{What We've Learned So Far}
    \begin{center}
    {\Large\bfseries The Big Picture}
    \end{center}
    ...
    \textbf{Probability distribution over vocabulary}
    \end{tcolorbox}

    \vspace{1em}

    \begin{tcolorbox}[colback=orange!10, colframe=orange!75!black]
    \centering
    \large
    Week 9 = Final step in text generation pipeline:\\
    \textbf{Choose which word to actually use}
    \end{tcolorbox}
\end{frame}

% Slide 8: What is Decoding?
...
% Slide 10: Beam Search Motivation
...
% Slide 11: Beam Search Visualization
\begin{frame}{Beam Search: The Full Picture}
    \begin{center}
    \includegraphics[width=0.95\textwidth,height=0.7\textheight,keepaspectratio]{../figures/beam_search_tree_graphviz.pdf}
    \end{center}
...
% Slide 13: Sampling Introduction
...
% Slide 15: Temperature Effects Visualization
...
% Slide 17: Top-p (Nucleus) Sampling
...
% Slide 18: Top-k vs Top-p Visualization
...
% Slide 19: The Decoding Landscape
...
% Slide 25: Creative Writing Example
...
% Slide 26: Code Generation Example
...
% Slide 27: Hyperparameter Tuning
...
% Slide 32: The Decoding Spectrum
