...
def setup_chart_A_bars():
    ...
    plt.tight_layout()
    plt.savefig('../figures/setup_A_bar_chart.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def setup_chart_B_list():
    ...
    plt.tight_layout()
    plt.savefig('../figures/setup_B_list.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def setup_chart_C_curve():
    ...
    plt.tight_layout()
    plt.savefig('../figures/setup_C_curve.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def setup_chart_D_nodes():
    ...
    dot.render('../figures/setup_D_nodes', cleanup=True)
    print("OK Setup D: Node diagram (graphviz)")

# === RUN ALL 4 ===
if __name__ == '__main__':
    import matplotlib.patches as mpatches  # Add import for Setup B
