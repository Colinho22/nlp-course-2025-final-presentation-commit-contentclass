...
def generate_quality_diversity_scatter():
    ...
    plt.tight_layout()
    plt.savefig('../figures/quality_diversity_scatter_bsc.pdf',
...
def generate_problem4_graphviz_charts():
    ...
    dot.render('../figures/problem4_search_tree_pruning_bsc', cleanup=True)
    ...
    dot2.render('../figures/problem4_path_comparison_bsc', cleanup=True)
    ...
    dot3.render('../figures/problem4_probability_evolution_bsc', cleanup=True)
    ...
    dot4.render('../figures/problem4_recovery_problem_bsc', cleanup=True)
...
def generate_extreme_case_1_greedy():
    ...
    plt.tight_layout()
    plt.savefig('../figures/extreme_greedy_single_path_bsc.pdf',
               dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_extreme_case_2_full_beam():
    ...
    plt.tight_layout()
    plt.savefig('../figures/extreme_full_beam_explosion_bsc.pdf',
               dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_extreme_case_3_computational_cost():
    ...
    plt.tight_layout()
    plt.savefig('../figures/extreme_computational_cost_bsc.pdf',
               dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_extreme_coverage_comparison():
    ...
    plt.tight_layout()
    plt.savefig('../figures/extreme_coverage_comparison_bsc.pdf',
               dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_practical_methods_coverage():
    ...
    plt.tight_layout()
    plt.savefig('../figures/practical_methods_coverage_bsc.pdf',
               dpi=300, bbox_inches='tight')
    plt.close()
