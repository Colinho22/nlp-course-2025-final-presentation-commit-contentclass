...
def generate_temperature_calculation():
    ...
    plt.tight_layout()
    plt.savefig('../figures/temperature_calculation_bsc.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_decoding_comparison():
    ...
    plt.tight_layout()
    plt.savefig('../figures/decoding_comparison_bsc.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_contrastive_mechanism():
    ...
    plt.tight_layout()
    plt.savefig('../figures/contrastive_mechanism_bsc.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_task_method_decision_tree():
    ...
    plt.tight_layout()
    plt.savefig('../figures/task_method_decision_tree_bsc.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_task_recommendations_table():
    ...
    plt.tight_layout()
    plt.savefig('../figures/task_recommendations_table_bsc.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_greedy_vs_sampling():
    ...
    plt.tight_layout()
    plt.savefig('../figures/greedy_vs_sampling_bsc.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_length_normalization():
    ...
    plt.tight_layout()
    plt.savefig('../figures/length_normalization_bsc.pdf', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_quality_metrics():
    ...
    plt.tight_layout()
    plt.savefig('../figures/quality_metrics_bsc.pdf', dpi=300, bbox_inches='tight')
    plt.close()
