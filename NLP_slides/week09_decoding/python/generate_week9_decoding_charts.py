...
if __name__ == "__main__":
    ...
    plot_decoding_landscape()
    print("- Decoding landscape created")
    plot_beam_search_tree()
    print("- Beam search tree created")
    plot_temperature_effects()
    print("- Temperature effects created")
    plot_sampling_strategies()
    print("- Sampling strategies comparison created")
    plot_decoding_quality_metrics()
    print("- Decoding quality metrics created")
    plot_decoding_selection_guide()
    print("- Decoding selection guide created")
    print("\nAll Week 9 visualizations completed!")