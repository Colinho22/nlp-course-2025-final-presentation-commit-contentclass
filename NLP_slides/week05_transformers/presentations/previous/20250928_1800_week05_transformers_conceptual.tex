% Week 5: Transformers - The Speed Revolution (Conceptual Charts Edition)
% NLP Course 2025
% Created: 2025-09-28 18:00
% Didactic Framework: Hope → Disappointment → Breakthrough
% Using completely new conceptual visualizations with metaphors
...
\vspace{5mm}
\begin{center}
\includegraphics[width=0.85\textwidth]{../figures/new_01_domino_effect.pdf}
\end{center}
...
\vspace{5mm}
\begin{center}
\includegraphics[width=0.85\textwidth]{../figures/new_02_traffic_visualization.pdf}
\end{center}
\end{frame}
...
\vspace{5mm}
\begin{center}
\includegraphics[width=0.85\textwidth]{../figures/new_05_broken_telegraph.pdf}
\end{center}
...
\vspace{5mm}
\begin{center}
\includegraphics[width=0.75\textwidth]{../figures/new_06_computational_quicksand.pdf}
\end{center}
...
\vspace{5mm}
\begin{center}
\includegraphics[width=0.85\textwidth]{../figures/new_08_circuit_board.pdf}
\end{center}
...
\vspace{5mm}
\begin{center}
\includegraphics[width=0.85\textwidth]{../figures/new_11_evolution_tree.pdf}
\end{center}
...
\vspace{5mm}
\begin{center}
\includegraphics[width=0.85\textwidth]{../figures/new_12_scaling_rocket.pdf}
\end{center}
