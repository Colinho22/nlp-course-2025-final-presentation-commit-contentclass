...
\end{itemize}
\end{columns}
\bottomnote{ Each act builds on the previous - no jumping ahead!}
\end{frame}
...
\colorbox{mlgreen!10}{\parbox{0.95\columnwidth}{
\footnotesize
...
\end{center}
\bottomnote{ The first neural network wasn't software---it was a room-sized machine with motors physically adjusting weights}
\end{frame}
...
\end{center}
\bottomnote{ Two simple linear boundaries combine to solve the impossible XOR problem}
\end{frame}
...
\end{center}
\bottomnote{ Watch as random weights organize into meaningful patterns through learning}
\end{frame}
...
\end{enumerate}
\end{columns}
\bottomnote{ This algorithm is still the foundation of all deep learning today}
\end{frame}
...
\end{itemize}
\end{columns}
\bottomnote{ The network literally learned English pronunciation overnight}
\end{frame}
...
\end{itemize}
\end{columns}
\bottomnote{ This theorem convinced skeptics that neural networks were worth pursuing}
\end{frame}
...
\end{center}
\bottomnote{ Gradients shrink exponentially through layers---this blocked deep learning until ReLU (2011)}
\end{frame}
...
\end{itemize}
\end{columns}
\bottomnote{ This simple idea scales to billions of parameters}
\end{frame}
...
\end{center}
\bottomnote{ Next: RNNs - Teaching networks to remember}
\end{frame}
...
\end{enumerate}
\end{columns}
\bottomnote{ Congratulations! You just built the same thing that stumped AI for 13 years!}
\end{frame}
