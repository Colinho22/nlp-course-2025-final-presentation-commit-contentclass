...
\begin{frame}{Appendix A: Advanced Topics}
\begin{center}
{\Large \textbf{Deep Dives for the Curious}}
\end{center}
\vspace{10mm}

\textbf{This section contains advanced material that goes beyond the core BSc curriculum.}

\vspace{5mm}
Topics covered:
\begin{itemize}
\item The Lottery Ticket Hypothesis
\item Inductive Biases in Neural Architectures
\item Scaling Laws and Performance Prediction
\item Deep vs Wide Network Architectures
\item Emergent Abilities at Scale
\item Advanced Optimization Algorithms
\end{itemize}

\vspace{5mm}
\textit{These topics are valuable for understanding state-of-the-art research but not essential for getting started with neural networks.}
\end{frame}
