...
if __name__ == "__main__":
    ...
    print("- Model compression landscape created")
    plot_quantization_levels()
    print("- Quantization levels visualization created")
    plot_knowledge_distillation()
    print("- Knowledge distillation diagram created")
    plot_pruning_strategies()
    print("- Pruning strategies visualization created")
    plot_deployment_pipeline()
    print("- Deployment pipeline created")
    plot_energy_efficiency_trends()
    print("- Energy efficiency trends created")
