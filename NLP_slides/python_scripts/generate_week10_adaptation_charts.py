...
if __name__ == "__main__":
    ...
    plot_adaptation_methods()
    print("- Adaptation methods comparison created")
    plot_lora_explanation()
    print("- LoRA explanation created")
    plot_prompt_patterns()
    print("- Prompt patterns visualization created")
    plot_finetuning_vs_prompting()
    print("- Fine-tuning vs prompting comparison created")
    plot_rlhf_process()
    print("- RLHF process diagram created")
    plot_adaptation_decision_tree()
    print("- Adaptation decision tree created")
