...
\begin{frame}[t]{From Words to Numbers: The Embedding Idea}
    ...
    \vspace{0.3em}
    \textbf{Answer:} Computers only process numbers. Embeddings give words numerical meaning so similar words have similar vectors (cat $\approx$ dog in vector space).
    \end{checkpoint}
\end{frame}
