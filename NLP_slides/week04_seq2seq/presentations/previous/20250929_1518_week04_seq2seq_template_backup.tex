...
% ==================== PART 1: TRANSLATION CHALLENGE ====================
\section{Part 1: Translation Challenge \& Motivation}
...
\usebeamerfont{title}\Large Part 1: Translation Challenge \& Motivation\par
\end{beamercolorbox}
\vfill
\textit{Why Word-by-Word Translation Fails}
\vfill
\end{frame}
...
% Part 1 Summary
\begin{frame}[t]{Part 1 Summary: Understanding the Challenge}
\begin{columns}[T]
\column{0.48\textwidth}
...
\section{Part 2: Encoder-Decoder Architecture}
...
\centering
\begin{beamercolorbox}[sep=8pt,center]{title}
\usebeamerfont{title}\Large Part 2: Encoder-Decoder Architecture\par
\end{beamercolorbox}
\vfill
\textit{Building Understanding, Then Generating}
\vfill
\end{frame}
...
% Part 2 Summary
\begin{frame}[t]{Part 2 Summary: The Encoder-Decoder Solution}
\begin{columns}[T]
\column{0.48\textwidth}
...
% ==================== PART 3: ATTENTION REVOLUTION ====================
\section{Part 3: The Attention Revolution}
...
\centering
\begin{beamercolorbox}[sep=8pt,center]{title}
\usebeamerfont{title}\Large Part 3: The Attention Revolution\par
\end{beamercolorbox}
\vfill
\textit{Looking Back at All Hidden States}
\vfill
\end{frame}
...
% Part 3 Summary
\begin{frame}[t]{Part 3 Summary: The Attention Revolution}
\begin{columns}[T]
\column{0.48\textwidth}
...
\end{beamercolorbox}
\vfill
\textit{From Research to Production}
\vfill
\end{frame}
